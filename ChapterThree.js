...
//  see whether it’s divisible by two. Here’s another way to
...
//  by writing "string"[N]. The returned value will be a
//  string containing only one character (for example, "b").
//  The first character has position 0, which causes the 
// last one to be found at position string.length -
//  1. In other words, a two-character string has length 2,
